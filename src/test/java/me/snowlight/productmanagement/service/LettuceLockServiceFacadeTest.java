...
import me.snowlight.productmanagement.facade.LettuceLockServiceFacade;
...
@SpringBootTest
public class LettuceLockServiceFacadeTest {
    @Autowired
    private StockRepository stockRepository;

    @Autowired
    private LettuceLockServiceFacade stockService;
